        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16">
            ...
            <div className="slide-right">
              <div className="relative aspect-[3/4] bg-sand-100 overflow-hidden mb-3 img-zoom rounded-none">
                <Image 
                ...
                <button 
                  ...
                  className={cn(
                    'absolute top-4 right-4 p-3 bg-white/90 backdrop-blur-sm rounded-none shadow-lg transition-all duration-300 hover:scale-110',
              ...
              <div className="flex gap-2 overflow-x-auto pb-2">
                {product.images.map((img, i) => (
                  <button 
                    ...
                    className={cn(
                      'relative w-16 sm:w-20 h-20 sm:h-24 flex-shrink-0 overflow-hidden transition-all duration-300 rounded-none',
            ...
            <div className="lg:py-4 slide-left delay-1">
                  ...
                  <div className="flex gap-2 sm:gap-3">
                    {product.colors.map((c, i) => (
                      <button 
                        ...
                        className={cn(
                          'w-8 h-8 sm:w-10 sm:h-10 rounded-none transition-all duration-300 border-2',
                ...
                <div className="flex flex-wrap gap-2">
                  {product.sizes.map((s) => (
                    <button 
                      ...
                      onClick={() => setSize(s)} 
                      className={cn(
                        'h-11 sm:h-12 min-w-[48px] sm:min-w-[52px] px-4 text-sm font-medium border-2 transition-all duration-300 rounded-none',
                        size === s 
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center border-2 border-gray-200 rounded-none">
                    <button 
              ...
              <button 
                ...
                disabled={!size} 
                className={cn(
                  'w-full py-4 text-sm font-medium tracking-wide transition-all duration-300 flex items-center justify-center gap-2 rounded-none',
                ...
                {product.care && product.care.length > 0 && (
                  <div>
                    ...
                    <ul className="text-sm space-y-1">
                      {product.care.map((c, i) => <li key={i} className="flex items-center gap-2"><span className="w-1 h-1 bg-gray-400 rounded-none" />{c}</li>)}
                    </ul>
                  </div>
                )}
              </div>
